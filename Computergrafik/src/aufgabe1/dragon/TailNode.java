...
/**
 * This {@link Node} represents a dragons tail.
 */
public class TailNode extends Node {

float x1,y1,z1,x2,y2,z2,x3,y3,z3;
	
	public TailNode(float x1,float y1,float z1,float x2,float y2,float z2,float x3,float y3,float z3){
		this.x1 = x1;
		this.x2 = x2;
		this.x3 = x3;
		this.y1 = y1;
